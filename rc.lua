...
local screenshot   = "xfce4-screenshooter"
local graphics     = "gimp"

awful.util.terminal = terminal
awful.util.tagnames = { "web", "web_secure", "3", "4", "5", "6", "7", "8", "torrents" }
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey}, "1",
        function ()
            awful.spawn.with_shell("mpc consume")
            beautiful.mpd.update()
        end),
    awful.key({ altkey}, "2",
        function ()
    ...
    awful.key({modkey, "Control"}, "Right",
          function ()
              os.execute("~/bin/mpc_next_album next")
          end),
     awful.key({modkey, "Control"}, "Left",
          function ()
              os.execute("~/bin/mpc_next_album prev")
          end),
    awful.key({ altkey }, "0",
        function ()
    ...
    awful.key({ altkey }, "c", function () awful.util.spawn(file_manager) end),
    awful.key({ modkey }, "g", function () awful.util.spawn(graphics) end),
    awful.key({ modkey }, "p", function () awful.util.spawn(screenshot) end),
